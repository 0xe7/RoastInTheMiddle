...
namespace RoastInTheMiddle.Lib.Krb
{
    public class HostAddress
    {
        ...
        public AsnElt Encode()
        {
            ...
            AsnElt addrStringElt = AsnElt.MakeString(AsnElt.IA5String, addr_string);
            addrStringElt = AsnElt.MakeImplicit(AsnElt.UNIVERSAL, AsnElt.GeneralString, addrStringElt);
